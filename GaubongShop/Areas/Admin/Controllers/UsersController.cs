...
namespace GaubongShop.Areas.Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDUser,Username,Password,UserRole")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDUser,Username,Password,UserRole")] User user)
        {
            if (ModelState.IsValid)
            {
